var Enemy = Tank.extend({
	...
	update : function() {
		...
		if(this.pressed & Network.PRESSED.LEFT) {
			this.moveLeft();
		} else if(this.pressed & Network.PRESSED.RIGHT) {
			this.moveRight();
		}

		if(this.pressed & Network.PRESSED.UP) {
			this.moveUp();
		} else if(this.pressed & Network.PRESSED.DOWN) {
			this.moveDown();
		}
